                    ...
                    <TimelineContent>
                        <Paper elevation={3} className={classes.paper} >
                            ...
                            <Typography variant="body2">
                                Revamped front-end of the company's website and admin site using <b>JavaScript</b> and <b>HTML/CSS</b>. Wrote <b>SQL</b> queries against database to import data and complete investigative work into support tickets. Created <b>VBA</b> macros to clean and extract customer data.
                        </Typography>
                        </Paper>
                    </TimelineContent>
                </TimelineItem>
